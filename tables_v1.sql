...
-- describe TRANSFERTRANS_V1
CREATE TABLE TRANSFERTRANS_V1 (
ID INTEGER NOT NULL PRIMARY KEY
, TABLE_TYPE TEXT NOT NULL UNIQUE
, ID_TABLE INTEGER NOT NULL
, ID_CHECKINGACCOUNT INTEGER NOT NULL
, ID_CURRENCY INTEGER NOT NULL
);
CREATE INDEX IDX_ID_CHECKINGACCOUNT ON TRANSFERTRANS_V1 (ID_CHECKINGACCOUNT);
